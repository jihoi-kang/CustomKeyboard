...
public class KeyboardEnglish {
    ...
    private final List<String> firstLineText = Arrays.asList("q", "w", "e", "r", "t", "y", "u", "i", "o", "p");
    private final List<String> secondLineText = Arrays.asList("a", "s", "d", "f", "g", "h", "j", "k", "l");
    private final List<String> thirdLineText = Arrays.asList("CAPS", "z", "x", "c", "v", "b", "n", "m", "DEL");
    ...
    public KeyboardEnglish(Context context, LayoutInflater layoutInflater, KeyboardInteractionListener keyboardInteractionListener) {
    ...
    public void init() {
        englishLayout = (LinearLayout) layoutInflater.inflate(R.layout.keyboard_action, null);
        ...
        LinearLayout numpadLine = englishLayout.findViewById(R.id.numpad_line);
        LinearLayout firstLine = englishLayout.findViewById(R.id.first_line);
        LinearLayout secondLine = englishLayout.findViewById(R.id.second_line);
        LinearLayout thirdLine = englishLayout.findViewById(R.id.third_line);
        LinearLayout fourthLine = englishLayout.findViewById(R.id.fourth_line);
    ...
    private View.OnLongClickListener getMyLongClickListener(TextView textView) {
            ...
            public boolean onLongClick(View view) {
                ...
                switch (textView.getText().toString()) {
                    ...
                    case "!#1":
                        ...
                        break;
                    default:
                        playClick(Integer.valueOf(textView.getText().toString().toCharArray()[0]));
            ...
            for (int item = 0; item < itemCount; item++) {
                ...
                switch (myText.get(item)) {
                    ...
                    case "Enter":
                        ...
                        break;
                    default:
                        TextView longClickTextView = linearLayout.getChildAt(item).findViewById(R.id.text_long_click);
                        ...
                        if (line > 0 && line < 4) { // 특수기호가 삽입될 수 있는 라인
                            longClickTextView.setText(myLongClickKeysText.get(line - 1).get(longClickIndex++));
